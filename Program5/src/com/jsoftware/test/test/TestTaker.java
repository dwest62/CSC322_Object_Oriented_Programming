...
public class TestTaker {
    ...
    private static void testQuestion(int index) {
        ...
        //	print question
        System.out.printf("\nQuestion %d of %d:\n%s\n%s\n",
                index + 1, SET.size(), "-".repeat(17), QUESTION.getQUESTION());
        ...
        try {
            ...
            System.out.printf("Fatal error processing Question. No handling for question type: %s. %s\n",
                    QUESTION.getClass(), ex.getMessage());
            System.exit(0);
        }
    }
    ...
    private static void printResults() {
        System.out.printf("\nYou got %d questions right out of %d total.\n", correctAnswerCount, SET.size());
    }
}
