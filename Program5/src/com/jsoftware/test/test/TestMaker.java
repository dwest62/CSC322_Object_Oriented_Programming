...
public class TestMaker {
    ...
    private static final CLIMenu MENU =
            new CLIMenu(
                new CLIOption[]{
    ...
    private static void init() {
        ...
        TEST_NAME = PromptHelper.getString("What would you like to call this test? ");
    }
    ...
    private static void addMultipleChoice() {
        ...
        final String[] CHOICES =
                Stream.of("first", "second", "third", "fourth")
                        .map(e -> PromptHelper.getString("Please enter your " + e + " choice: "))
                        .toArray(String[]::new);
    ...
    private static void addFillInBlanks() {
		...
		/*
			User will be prompted for a String ANSWER which is split on comma, trimmed of whitespace, and collected to
			 array.
			Sanitize Prompt display error message and retry prompt if any exception is thrown.
		*/
        final IQuestion Q =
                PromptHelper.sanitizePrompt(
                    () -> {
                        final String ANSWER =
    ...
    private static void exit() {
        ...
        FACTORY.save(SET, TestMaker.TEST_NAME.matches(".dat$") ? TestMaker.TEST_NAME : TestMaker.TEST_NAME + ".dat");
        System.out.println("\nTest saved\nGoodbye!");
    }
}
